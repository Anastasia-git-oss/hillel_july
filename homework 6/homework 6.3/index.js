let users = [{index:0,isActive:true,balance:2226.60,name:"Eugenia Sawyer",gender:"female",phone:"+1 (840) 583-3207",address:"949 John Street, Rose, Puerto Rico, 1857"}, 
...
for (let index = 0; index < users.length; index++) {
    if (users[index].balance > 2000) {
        phones.push(users[index].phone);
    }
    
    balances += users[index].balance;
}
console.log(`Телефони користувачів, баланс яких більше 2000: ${phones}`);
console.log(`Сума балансів всіх користувачів: ${balances}`);